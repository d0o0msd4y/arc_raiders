...
- **Inventory stepper** — tap `‹` / `›` to set how many of each item you have
- **Auto-complete** — item checks itself off when your count hits the required amount
...
*Data based on the community-maintained upgrade list. Credit to u/RemarkableDream1528 for totals.*
